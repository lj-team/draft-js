...
var DraftModifier = {
  ...
  moveText: function(
    ...
    if (
      removalRange.getStartKey() !== removalRange.getEndKey() &&
      targetRange.getStartKey() === targetRange.getEndKey() &&
      removalRange.getEndKey() === targetRange.getStartKey()
    ) {
      var afterReplace = DraftModifier.replaceWithFragment(
        contentState,
        targetRange,
        movedFragment
      );
      return DraftModifier.removeRange(
        afterReplace,
        removalRange,
        'backward'
      );
